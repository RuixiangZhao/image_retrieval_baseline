...
if __name__ == "__main__":
    ...
    if args.extract_image_feats:
        ...
        if args.image_feat_output_path is None:
            args.image_feat_output_path = "{}.img_feat.epoch10.jsonl".format(args.image_data[:-4]) #!! 修改文件名,防止被覆盖
        write_cnt = 0
    ...
    if args.extract_text_feats:
        ...
        if args.text_feat_output_path is None:
            args.text_feat_output_path = "{}.txt_feat.epoch10.jsonl".format(args.text_data[:-6]) #!!
        write_cnt = 0
