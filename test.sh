...
python -u src/eval/make_topk_predictions.py \
    --image-feats="${DATAPATH}/MR_test_imgs.224.img_feat.epoch${epoch_num}.jsonl" \
    --text-feats="${DATAPATH}/MR_test_queries.txt_feat.epoch${epoch_num}.jsonl" \
    --top-k=10 \
    --eval-batch-size=32768 \
    --output="${DATAPATH}/MR_test_predictions.epoch${epoch_num}.jsonl"